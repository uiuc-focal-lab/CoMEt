...
device = 'cpu' #'cpu' #if torch.cuda.is_available() else 'cpu'  # for some reason, my cpu is faster!
...
class Ithemal(nn.Module):
    def __init__(self, model_file):
        ...
        self.load_state_dict(torch.load(model_file))  # this file contains all the model weights
...
def main():
    model = Ithemal('/home/isha/Documents/cost_model_exp/code_predicates/models/Ithemal_gpu/ithemal_trained_against_uica')
    print(model(['.intel_syntax noprefix; push rax; div r10; mov dword ptr [rbx], eax; add rax, rbx; cmp rbx, rdx']))
