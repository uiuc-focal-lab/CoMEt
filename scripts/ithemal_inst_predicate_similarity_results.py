...
ITHEMAL_DIR = 'data/port_explanations_only_deletion/Ithemal'
UICA_DIR = 'data/port_explanations_only_deletion/uica'
...
df_hsw = pd.read_csv('data/Ithemal_dataset/explanation_dataset.csv')
