...
def main():
    ...
    parser.add_argument("--precision_threshold", nargs='?', type=float, help='precision threshold for the Anchors algorithm (default=0.82)')
    parser.add_argument("--perturbation_probability", nargs='?', type=float, help='probability parameter in perturbation model (default=0.5)')
